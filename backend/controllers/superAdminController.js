...
export const fetchAllUsers = catchAsyncErrors(async (req, res, next) => {
    ...
    const transformDataToMonthArray = (data, totalMonths = 12) => {
    ...
    const biddersArray = transformDataToMonthArray(bidders);
    const auctioneersArray = transformDataToMonthArray(auctioneers);
...
export const monthlyRevenue = catchAsyncErrors(async (req, res, next) => {
    ...
    const transformDataToMonthArray = (payments, totalMonths = 12) => {
        const result = Array(totalMonths).fill(0);
    ...
    const totalMonthlyRevenue = transformDataToMonthArray(payments);
    res.status(200).json({
        success: true,
        totalMonthlyRevenue,
    })
